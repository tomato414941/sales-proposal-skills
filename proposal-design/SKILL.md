...
```bash
python3 proposal-design/scripts/init_proposal_artifacts.py --cwd "$PWD"
```
...
```bash
npm run render:pptx -- --cwd "$PWD" --output "$PWD/.proposal/proposal.pptx"
```
...
- [artifact_rules.md](artifact_rules.md): artifact ごとの役割、必須セクション、frontmatter ルール
- [outline_template.md](outline_template.md): `50_outline.md` の書き方
- [deck_template.md](deck_template.md): `70_deck_draft.md` の書き方
- [validation_checklist.md](validation_checklist.md): validation 観点
